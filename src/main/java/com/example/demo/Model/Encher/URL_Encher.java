...
public class URL_Encher {
    ...
    public List<Encher> get_encher_by_id(@Validated @RequestBody String id) {
        System.out.println("get_encher_by_id"+id);
        List<Encher> val=new ArrayList<>();
        val.add(Encher.get_by_id(id));
        return val;
    }
    ////Encherir
